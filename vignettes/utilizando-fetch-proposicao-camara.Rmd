...
```{r}
fetch_proposicao_camara(dataApresentacaoInicio = "2017-01-01", dataApresentacaoFim = "2017-01-31") %>%
  glimpse()
```
...
```{r}
fetch_proposicao_camara(dataInicio = "2017-11-01", dataFim = "2017-11-30") %>%
  glimpse()
```
...
```{r}
fetch_proposicao_camara(siglaPartidoAutor = "PSC", itens = 100) %>%
  glimpse()
```
...
fetch_proposicao_camara(siglaUfAutor = estados_nordeste, itens = 100) %>%
  glimpse()
```
...
tryCatch(
  fetch_proposicao_camara(autor = autores) %>%
